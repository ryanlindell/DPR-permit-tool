...
4. In **SQL Editor**, run `supabase/migrations/20260924000100_schema_and_rls.sql`, then `supabase/migrations/20260924000200_rpc_functions.sql`. Run each whole file and wait for the success result before continuing.
